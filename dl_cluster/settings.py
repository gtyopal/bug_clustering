...
related_bug_keyfeature_files = os.path.join(PARENT_DIR_PATH,'clusterdata', cluster_type + '_related_bug_result_iot' )
related_bug_keyfeature_files_json = os.path.join(PARENT_DIR_PATH,'clusterdata', cluster_type + '_related_bug_result_iot_json' )
...
nlp_fields = ['bf_bugid', 'bf_headline', 'bf_attribute', 'bf_description', 'bf_symptoms', 'bf_conditions',
              'bf_workarounds', 'bf_release_note', 'bf_duplicateofbug']
# 'logs', 'reproduce', 'big_bf_description',,  'bf_symptoms','bf_conditions', 'bf_workarounds', 'bf_release_note'

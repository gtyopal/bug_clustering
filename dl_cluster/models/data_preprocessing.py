...
def load_dataset():
    ...
    bug_fields = ['bf_bugid', 'bf_component', 'bf_project', 'bf_product', 'bf_de_manager', 'bf_severity',
                  'bf_submitted_on', 'bf_headline', 'bf_attribute', 'bf_description','bf_symptoms', 'bf_conditions', 'bf_workarounds','bf_release_note']
    # ,'Found','Version',,'logs', 'reproduce', 'big_bf_description'
    nlp_fields = [ 'bf_headline', 'bf_attribute', 'bf_description','bf_symptoms', 'bf_conditions', 'bf_workarounds','bf_release_note']
    # 'logs', 'reproduce', 'big_bf_description','bf_duplicateofbug',,  'bf_symptoms','bf_conditions', 'bf_workarounds', 'bf_release_note'
    nonnlp_fields = ['bf_component', 'bf_project', 'bf_product', 'bf_de_manager', 'bf_severity','bf_submitted_on']
    table = pq.read_table(config.bug_data, columns=bug_fields)
    df = table.to_pandas()[:100]
    ...
    # df_bug_nlp.set_index('bf_bugid',inplace=True)
    # df_bug_nlp.drop(columns='bf_bugid', inplace=True)
...
def clean_dataset(df):
    bug_fields = ['bf_bugid', 'bf_component', 'bf_project', 'bf_product', 'bf_de_manager', 'bf_severity',
                  'bf_submitted_on', 'bf_headline', 'bf_attribute', 'bf_description']
    nlp_fields = ['bf_bugid', 'bf_headline', 'bf_attribute', 'bf_description']
